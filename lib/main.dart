...
class Myclass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: Text("Quotes Hub"),centerTitle: true,
        actions: <Widget>[
...
class MyhomePage extends StatelessWidget {
  ...
  "Your worth is=n’t defined by whether or not someone else loves, sees, values, appreciates, or adores you, it’s inherent. You are worthy because you’re alive, regardless of your mistakes or failures.",
  "My fault, my failure, is not in the passions I have, but in my lack of control of them.",
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ListView.builder(itemCount:quotes.length,itemBuilder: (BuildContext context,int count){
        return Card(
          color: Colors.white,
          elevation: 10.0,
          child: ListTile(
            title: Text(quotes[count],
              style: TextStyle(
                color: Colors.black,
              ),
            ),
